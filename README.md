[![MIT license](https://img.shields.io/badge/License-MIT-blue.svg?style=flat)](https://github.com/thushan/hyde-hyde/blob/master/LICENSE.md) ![GitHub release](https://img.shields.io/github/release/thushan/hyde-hyde.svg) ![GitHub stars](https://img.shields.io/github/stars/thushan/hyde-hyde.svg) ![GitHub forks](https://img.shields.io/github/forks/thushan/hyde-hyde.svg) ![GitHub issues](https://img.shields.io/github/issues/thushan/hyde-hyde.svg) ![GitHub issues closed](https://img.shields.io/github/issues-closed/thushan/hyde-hyde.svg)
...
* The main styles are refactored and redeveloped using SCSS (see [_assets/scss_](https://github.com/thushan/hyde-hyde/blob/master/assets/scss)),  `poole.css` and `hyde.css` are no longer needed because `hyde-hyde.scss` already incorporates relevant elements (I still keep them there for reference purpose)
...
* The layouts have been heavily restructured and modularised further (see [_layouts_](https://github.com/thushan/hyde-hyde/blob/master/layouts))
* Adding '[_Portfolio_](https://github.com/thushan/hyde-hyde/blob/master/layouts/portfolio)' page inspired by Xiaoying Riley (@3rdwave_themes) [Developer-Theme](https://github.com/xriley/developer-theme)
...
For more details, please refer to [CHANGELOG](https://github.com/thushan/hyde-hyde/blob/master/CHANGELOG.md).  A real site in action can be found [here](https://thushan.github.io) and its [WIP source](https://github.com/thushan/thushan-blog) for reference.
...
$ git clone https://github.com/thushan/hyde-hyde.git themes/hyde-hyde

# or just add hyde-hyde as a submodule
$ git submodule add https://github.com/thushan/hyde-hyde.git themes/hyde-hyde
```
...
* `highlightjs = true`: use [highlight.js](https://highlightjs.org) instead of Hugo built-in support for code highlighting
  ...
  * Since [v2.0.1](https://github.com/thushan/hyde-hyde/tree/v2.0.1), highlighting for each page can be fine-tuned in the front matter, for example
...
*  `include_toc = false`: Setting to `false` in FrontMatter will disable too short TOC data as your want. 
  ...
  * Per PR [#56](https://github.com/thushan/hyde-hyde/commit/5ed13e17400bbc09a342b60fd50cd9fe3e6f1525), Gravatar pics can be used exclusively to `.Site.Params.authorimage` via the parameter `.Site.Params.social.gravatar`
...
* Most of the customisable SCSS styles in [_assets/scss/hyde-hyde_](https://github.com/thushan/hyde-hyde/blob/master/assets/scss/hyde-hyde) and Hugo templates in [_hyde-hyde/layouts_](https://github.com/thushan/hyde-hyde/blob/master/layouts) are modularised and can be altered/adapted easily.
...
> * `featured: true` : when you want to show a project as featured project. It is default to `false`. Note that only one project should be marked `featured: true` , otherwise, the result could be random as [the Hugo template](https://github.com/thushan/hyde-hyde/blob/master/layouts/partials/portfolio/content.html) will take the first one.
> * The body of the Markdown file will be the summary of the project.

If you want to adjust the portfolio page to your needs, please have a look at the [main template](https://github.com/thushan/hyde-hyde/blob/master/layouts/portfolio/list.html), that uses this [partial template](https://github.com/thushan/hyde-hyde/blob/master/layouts/partials/portfolio/content.html) and [this SCSS style](https://github.com/thushan/hyde-hyde/blob/master/assets/scss/hyde-hyde/_project.scss).

## Some Screenshots

### Main page

![hyde-hyde main screen](https://github.com/thushan/hyde-hyde/raw/master/images/main.png)

### A post

![A post in hyde-hyde](https://github.com/thushan/hyde-hyde/raw/master/images/post.png)

### Portfolio

![Portfolio hyde-hyde](https://github.com/thushan/hyde-hyde/raw/master/images/portfolio.png)



### Mobile Mode with Collapsible Menu

<img src='https://github.com/thushan/hyde-hyde/raw/master/images/mobile.png' alt='hyde-hyde in mobile mode' width='60%'>
